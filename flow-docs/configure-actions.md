---
title: Configurer des actions pour les workflows dans PowerApps | Microsoft Docs
ms.custom: ''
ms.date: 06/27/2018
ms.reviewer: ''
...
## <a name="next-steps"></a>Étapes suivantes  
 ...
 [Supervision des workflows en temps réel et des actions](monitor-manage-processes.md#BKMK_MonitorSyncWorkflows)
